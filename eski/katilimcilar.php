...
<html>
  ...
  <body>
  	  ...
  	  <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
			...
			<a href="#">YARIŞLAR</a>
			<a href="#" class="aktif">KATILIMCILAR</a>
            ...
            <div class="col width100">
              <div class="row">
                <div class="filterable table-responsive">
                  <div class="text-right colorblue width100 borderradtop10">
                      <button class="btn btn-info btn-filter" style="margin-right: 10px!important;">Filtrele</button>
                  </div>
                  <table class="table table-responsive colorwhite borderrad-bot-10">
                    <thead>
                      <tr class="filters">
                        ...
                        <th><input type="text" class="form-control" placeholder="Künye No" disabled></th>
                        <th><input type="text" class="form-control" placeholder="Şehir" disabled></th>
                        <th><input type="text" class="form-control" placeholder="Ülke" disabled></th>
